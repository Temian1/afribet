...
const KYC_META = {
    unverified: { label: 'Not verified', cls: 'border-[var(--pf-border)] bg-slate-100 text-slate-600 dark:bg-white/[.06] dark:text-slate-300' },
        ...
        <div className="card p-5">
            ...
            <div className="mt-6 border-t border-[var(--pf-border)] pt-5">
                ...
                <div className="mt-3 grid gap-2">
                    ...
                    {sessions.map((s) => (
                        <div key={s.id} className="flex items-center justify-between gap-3 rounded-xl border border-[var(--pf-border)] px-3.5 py-2.5">
