...
const UI_OUTLINED = {
    ...
    phone: <><rect x="6" y="2.5" width="12" height="19" rx="2.6" /><path d="M10.5 5.5h3M11 18.5h2" /></>,
    hash: <path d="M9 3.5 7.5 20.5M16.5 3.5 15 20.5M3.5 8.5h17M3 15.5h17" />,
    copy: <><rect x="9" y="9" width="12" height="12" rx="2.2" /><path d="M5.5 15H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v.5" /></>,
    image: <><rect x="3" y="4.5" width="18" height="15" rx="2.4" /><circle cx="8.5" cy="10" r="1.6" /><path d="m4 17 4.5-4.5 3.5 3.5 3-3L20 17" /></>,
    upload: <><path d="M12 16V4.5M8 8l4-3.5L16 8" /><path d="M4 15v3.5A1.5 1.5 0 0 0 5.5 20h13a1.5 1.5 0 0 0 1.5-1.5V15" /></>,
